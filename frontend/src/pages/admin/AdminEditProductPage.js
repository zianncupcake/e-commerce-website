import AdminEditProductPageComponent from "../../components/admin/AdminEditProductPageComponent";
...
const updateProduct = async (id, formInputs) => {
...
const AdminEditProductPage = () => {
  ...
  return <AdminEditProductPageComponent getProduct={getProduct} updateProduct={updateProduct} uploadImages={uploadImages} getCategories={getCategories} makeNewCategory={makeNewCategory} makeNewAttribute={makeNewAttribute}/>;
};
