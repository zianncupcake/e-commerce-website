import {
  ...
  const AdminCreateProductPageComponent = ({createProduct, uploadImages, getCategories, makeNewCategory, makeNewAttribute}) => {
    ...
    useEffect(() => {
        ...
        .then(res => {
            setCategories(res);
            console.log("exisiting categories", res);
    ...
    const handleSubmit = (event) => {
        ...
        if (event.currentTarget.checkValidity() === true) {
            ...
            .then(data => {
                ...
                if (data.message === "product created") setSuccess(true);
            })
            .catch(er => {
