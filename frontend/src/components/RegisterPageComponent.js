...
const RegisterPageComponent = ({ registerUser }) => {
  ...
  const onChange = () => {
    //select first element that matches specified css selector. attribute name set to password/confirmPassword
  ...
  const handleSubmit = (event) => {
    ...
    //constraint validation api provides checkvalidity method
